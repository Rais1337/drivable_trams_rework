...
function Drivtrams.DebugTrain1()
...
function Drivtrams.DebugTrain2()
...
function Drivtrams.DebugTrain(base,ang)
...
function Drivtrams.SpawnDepot1(idx)
	if (not idx) or (idx == 1) then Drivtrams.DebugTrain(Vector(-2235.816406,-7250.668457,-2486.183594),Angle(0,90-11.25,0)) end
	if (not idx) or (idx == 2) then Drivtrams.DebugTrain(Vector(-2233.157715,-8258.770508,-2486.118652),Angle(0,90-11.25,0)) end
	if (not idx) or (idx == 3) then Drivtrams.DebugTrain(Vector(-2231.008301,-9273.424805,-2486.197266),Angle(0,90-11.25,0)) end
end
