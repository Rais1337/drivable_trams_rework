...
Drivtrams.RerailGetTrackData = getTrackData
...
local function RerailConCMDHandler(ply,cmd,args,fullstring)
	...
	if train:GetClass() == "gmod_trams_bogey" then
		Drivtrams.RerailBogey(train)
	else
...
--------------------------------------------------------------------------------
function Drivtrams.RerailBogey(bogey)
...
--------------------------------------------------------------------------------
function Drivtrams.RerailTrain(train)
