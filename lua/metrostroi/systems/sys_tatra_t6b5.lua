...
Drivtrams.DefineSystem("T6B5_Systems")
...
function TRAIN_SYSTEM:Think()	
	...
	if self.Train.CoupledTrains then
		sys = self.Train.CoupledTrains[1].Systems["T6B5_Systems"]
